...
export default function Medicines(props) {
    ...
    useEffect(() => {
        if (props.location.state) {
            setMedicine({
                ...medicine,
                pacientName: props.location.state[1] || '', // Valor vazio se indefinido
                id: props.location.state[0].id || '', // Valor vazio se indefinido
                medicineName: props.location.state[0].medicineName || '', // Valor vazio se indefinido
                medicineDosage: props.location.state[0].medicineDosage || '', // Valor vazio se indefinido
                medicineHours: props.location.state[0].medicineHours || '', // Valor vazio se indefinido
                medicineHours2: props.location.state[0].medicineHours2 || '', // Valor vazio se indefinido
                medicineHours3: props.location.state[0].medicineHours3 || '', // Valor vazio se indefinido
                medicineDateStart: props.location.state[0].medicineDateStart || '', // Valor vazio se indefinido
                medicineDateEnd: props.location.state[0].medicineDateEnd || '', // Valor vazio se indefinido
                medicineObservation: props.location.state[0].medicineObservation || '', // Valor vazio se indefinido
            });
            setIsEditing(!isEditing);
        }
    }, [props.location.state]);
